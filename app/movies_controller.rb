...
def can_be_created_in_a_block(id: nil, title: "Home Alone", release_date: 1990)
...
def can_update_using_update_method
  ...
  wat_huh = wat.update(title: "Wat, huh?")
end
...
def can_destroy_a_single_item
  ...
  Movie.where(title: "That One Where the Guy Kicks Another Guy Once").destroy(1)
end
